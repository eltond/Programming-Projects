...
def main():
 ...
 LOC = 'C:\Users\NYU\Assignment3\TextFiles\\'
 for i in range(0,10):
  File = url + str(6334220+i) + '.txt'
  Target = LOC + str(6334220+i) + '.txt'
  urllib.urlretrieve(File,Target)
  with open(Target) as f:
   FileCorpus.append(f.read().splitlines()) 
 for i in FileCorpus:
 ...
 for i,f in enumerate(StopCorpus):
  ...
  OPFile = "Modelled_Topics_" + str(6334220+i) + ".txt"
  ...
  f = open('C:\Users\NYU\Assignment3\Output\\' + OPFile, "w")
  f.write("Topic #" + "1" + "\n");
  f.write(TopTopics1 + "\n");
  f.write("\n");
  f.write("Topic #" + "2" + "\n");
